...
**NOTE:** Mod seeks for any dialogue for concrete reaction key in this order. That means if you specify reaction for seeds category (id number -74) and for object *Parsnip Seeds*, then if you gift Parsnip Seeds to your concrete NPC, then you see dialogue for *Pasrsnip Seeds*. If you gift other seeds, you see dialogue for seeds category.
